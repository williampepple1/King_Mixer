...
WelcomeLabel2=This will install King Mixer v1.2.0 on your computer.%n%nKing Mixer is a professional VST3 channel strip plugin with an 8-band interactive EQ, compressor, saturation, advanced reverb engine, and stereo width control.%n%nFeatures include 64 genre/instrument presets, real-time spectrum analysis, 5 selectable UI themes, and FabFilter-inspired visual feedback.%n%nIt is recommended that you close any running DAWs before continuing.
